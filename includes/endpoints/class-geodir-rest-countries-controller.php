<?php
/**
 * REST API: Geodir_REST_Countries_Controller class
 *
 */

/**
 * Core class used to manage countries via the REST API.
 *
 *
...
class Geodir_REST_Countries_Controller extends WP_REST_Controller {
     ...
     * @var string
     */
    public $object_type = 'geodir_country';
